...
public class Calle {
	 ...
	 * @param pInclinacion
	 */
	public Calle(int pTipo, int pPuntoInicial, int pPuntoFinal, int pPosX, int pPosY, int pSeñal,int pVelocidadMax,GenericList<Integer> pInterseccion_X, GenericList<Integer> pInterseccionY, int pInclinacion){
		this._tipo = pTipo;
